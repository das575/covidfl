...
for date in reversed(date_list_lastx):
    ...
    for region in region_list:
        ...
        print('DIFFERENCE: ',list_subtract(day0_data.values.tolist(), day1_data.values.tolist()))
        region_date_chg.append([region] + [date_last_str] + day0_data + list_subtract(day0_data.values.tolist(), day1_data.values.tolist()))
